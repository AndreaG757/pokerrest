...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler)
				...
				.permitAll().antMatchers("/public/**").permitAll().antMatchers(HttpMethod.GET, "/api/gestionetavolo/**")
				.hasAnyAuthority("ROLE_SPECIAL_PLAYER", "ROLE_ADMIN").antMatchers(HttpMethod.POST, "/api/gestioneamministrazione/**")
				.hasAnyAuthority("ROLE_PLAYER", "ROLE_SPECIAL_PLAYER", "ROLE_ADMIN").antMatchers("/api/playmanagement/**")
